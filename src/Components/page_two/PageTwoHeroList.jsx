...
<div className="grid grid-cols-6 md:grid-cols-8 gap-2 md:gap-1 lg:gap-2 text-center md:text-xs  lg:text-base mb-10 lg:mx-5 ">
  ...
  <p className="heroBorder rounded-lg py-2 col-span-3 md:col-span-1 md:ml-0 ml-1">Engineering</p>
  <p className="heroBorder rounded-lg py-2 col-span-3 md:col-span-1 md:mr-0 mr-1">Management</p>
  <p className="heroBorder rounded-lg py-2 col-span-2 md:col-span-1">Finance</p>
  <p className="heroBorder rounded-lg py-2 col-span-2 md:col-span-1">Marketing</p>
